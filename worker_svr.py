...
# 【关键】独立的组名
GROUP_NAME = "group_svr"
CONSUMER_NAME = "worker_svr"
        ...
        for msg_id, data in messages:
            ...
            if msg_type == "sample":
                ...
                if len(samples) == TOTAL_EXPECTED:
                    print(f"📦 [SVR] 数据集接收完成 ({len(samples)})，开始训练...")
